...
def test_nft_claimed_with_nonzero_multiplier(
    admin, local_account, FoundingFrogVault, voting_power_aggregator
):
    ...
    frog_vault = admin.deploy(
        FoundingFrogVault, voting_power_aggregator, admin, 6e18, root
    )
    frog_vault.claimNFT(
        ACCOUNT_ADDRESS,
        multiplier,
